    ...
    useEffect(() => {
        if (product) {
            setFormData({
                ...
                altNames: product.altNames ? product.altNames.join(', ') : '',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const productData = {
                ...
                images: formData.images, // Already an array from SimpleImageUpload
            ...
            // Call the parent component's function to update the product
            await onProductUpdated(product.productId, productData);
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        />
                        <p className="text-xs text-gray-500 mt-1">e.g., Moisturizer, Anti-Aging Cream, Vitamin C Serum</p>
                    </div>
